...
Page({
  ...
  onReady: function (e) {
    ...
    app.menuConfig = {
      menu: [
        { 'index': 0, 'menu': '表白墙', 'src': './../../images/icon/love.png', },
        { 'index': 1, 'menu': '跳蚤市场', 'src': './../../images/icon/market.png' },
        { 'index': 2, 'menu': '玩点啥', 'src': './../../images/icon/yule.png' },
        { 'index': 3, 'menu': '吃点啥', 'src': './../../images/icon/hamburg.png' },
        { 'index': 4, 'menu': '敬请期待', 'src': './../../images/icon/more.png' },
      ]
    }
    // 绘制转盘
